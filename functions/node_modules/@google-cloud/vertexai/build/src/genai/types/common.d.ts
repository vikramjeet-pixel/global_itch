...
export declare enum AgentServerMode {
    /**
...
export declare enum ManagedTopicEnum {
    /**
...
export declare enum MachineConfig {
    /**
...
export declare enum MemoryMetadataMergeStrategy {
    /**
...
/** The action to take. */
export declare enum GenerateMemoriesResponseGeneratedMemoryAction {
    /**
...
export declare interface CreateAgentEngineConfig {
    ...
    /** The agent framework to be used for the Agent Engine.
        ...
        - If `source_packages` is specified, the agent framework will
          default to "custom". */
    agentFramework?: 'google-adk' | 'langchain' | 'langgraph' | 'ag2' | 'llama-index' | 'custom';
...
export declare class ListReasoningEnginesResponse {
...
export declare class QueryReasoningEngineResponse {
...
export declare class GenerateMemoriesResponseGeneratedMemory {
...
export declare class GenerateMemoriesResponse {
...
export declare class ListReasoningEnginesMemoriesResponse {
    /** Used to retain the full HTTP response. */
    sdkHttpResponse?: genaiTypes.HttpResponse;
    nextPageToken?: string;
...
/** A retrieved memory. */
export declare class RetrieveMemoriesResponseRetrievedMemory {
...
export declare class RetrieveMemoriesResponse {
...
export declare class PurgeMemoriesResponse {
...
export declare class ListAgentEngineMemoryRevisionsResponse {
    /** Used to retain the full HTTP response. */
    sdkHttpResponse?: genaiTypes.HttpResponse;
    nextPageToken?: string;
...
export declare class ExecuteSandboxEnvironmentResponse {
...
export declare class ListAgentEngineSandboxesResponse {
    /** Used to retain the full HTTP response. */
    sdkHttpResponse?: genaiTypes.HttpResponse;
    nextPageToken?: string;
...
export declare class ListReasoningEnginesSessionsResponse {
    /** Used to retain the full HTTP response. */
    sdkHttpResponse?: genaiTypes.HttpResponse;
    nextPageToken?: string;
...
export declare class AppendAgentEngineSessionEventResponse {
}
...
export declare class ListAgentEngineSessionEventsResponse {
    /** Used to retain the full HTTP response. */
    sdkHttpResponse?: genaiTypes.HttpResponse;
    nextPageToken?: string;
...
/** Response from LRO. */
export declare class CheckQueryJobResponse {
    /** Used to override HTTP request options. */
    httpOptions?: genaiTypes.HttpOptions;
    /** Abort signal which can be used to cancel the request.
